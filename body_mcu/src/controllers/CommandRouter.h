...
#ifndef BODY_MCU_COMMANDROUTER_H
#define BODY_MCU_COMMANDROUTER_H
...
public:
  ...
  void begin(uint32_t baud, EspSoftwareSerial::Config config, int8_t rxPin,
             int8_t txPin);
  void loop();
...
#endif // BODY_MCU_COMMANDROUTER_H
